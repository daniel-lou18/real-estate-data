...
describe("mappers", () => {
  describe("COLUMN_MAP", () => {
    it("should contain all expected column mappings", () => {
      const expectedColumns: AllowedColumns[] = [
        "date",
        "year",
        "month",
        "primaryInseeCode",
  ...
  describe("compileFilters", () => {
    ...
    it("should compile equality filter", () => {
      const filters = [
        { field: "price" as AllowedColumns, operator: "=", value: 100000 },
      ];
    ...
    it("should throw error for invalid between filter", () => {
      ...
      expect(() => compileFilters(filters)).toThrow(
    ...
    it("should compile in filter", () => {
      const filters = [
        {
          field: "propertyTypeCode" as AllowedColumns,
          operator: "in",
          value: ["A", "B", "C"],
        },
      ];
    ...
    it("should compile ilike filter", () => {
      const filters = [
        {
          field: "propertyTypeLabel" as AllowedColumns,
          operator: "ilike",
          value: "%house%",
        },
      ];
    ...
    it("should throw error for unsupported field", () => {
      ...
      expect(() => compileFilters(filters)).toThrow(
        "Unsupported filter field: invalidField"
      );
    });
    ...
    it("should handle multiple filters", () => {
      const filters = [
        { field: "price" as AllowedColumns, operator: ">", value: 100000 },
        { field: "year" as AllowedColumns, operator: "=", value: 2023 },
      ];
      const result = compileFilters(filters);
      expect(result).toBeDefined();
    });
  ...
  describe("compileSort", () => {
    ...
    it("should compile single sort field", () => {
      const sort = [{ field: "price" as AllowedColumns, dir: "asc" as const }];
    ...
    it("should compile multiple sort fields", () => {
      const sort = [
        { field: "price" as AllowedColumns, dir: "desc" as const },
        { field: "date" as AllowedColumns, dir: "asc" as const },
      ];
      const result = compileSort(sort);
      expect(result).toBeDefined();
    ...
    it("should default to asc when dir is not specified", () => {
      const sort = [{ field: "price" as AllowedColumns }];
      const result = compileSort(sort);
      expect(result).toBeDefined();
    });

    it("should throw error for unsupported sort field", () => {
      const sort = [{ field: "invalidField" as any, dir: "asc" as const }];
      expect(() => compileSort(sort)).toThrow(
  ...
  describe("compileSelect", () => {
    ...
    it("should compile single select field", () => {
      const select = ["price" as AllowedColumns];
    ...
    it("should compile multiple select fields", () => {
      const select = [
        "price" as AllowedColumns,
        "date" as AllowedColumns,
        "year" as AllowedColumns,
      ];
      const result = compileSelect(select);
      expect(result).toBeDefined();
      expect(result).toHaveProperty("price");
    ...
    it("should throw error for unsupported select field", () => {
      const select = ["invalidField" as any];
      expect(() => compileSelect(select)).toThrow(
        "Unsupported select field: invalidField"
      );
    });
  });
  ...
  describe("compileGroupBy", () => {
    it("should compile single group by field", () => {
      const groupBy = ["date" as keyof typeof COLUMN_MAP];
    ...
    it("should compile multiple group by fields", () => {
      const groupBy = [
        "date" as keyof typeof COLUMN_MAP,
        "year" as keyof typeof COLUMN_MAP,
      ];
      const result = compileGroupBy(groupBy);
      expect(result).toBeDefined();
      expect(result).toHaveLength(2);
    ...
    it("should throw error for unsupported group by field", () => {
      const groupBy = ["invalidField" as any];
      expect(() => compileGroupBy(groupBy)).toThrow(
        "Unsupported group by: invalidField"
      );
    });
  });
  ...
  describe("compileMetrics", () => {
    ...
    it("should compile sum metric", () => {
      const metrics = [
        { metric: "sum" as const, field: "price" as AllowedColumns },
      ];
      const result = compileMetrics(metrics);
      expect(result).toBeDefined();
    ...
    it("should compile min metric", () => {
      const metrics = [
        { metric: "min" as const, field: "price" as AllowedColumns },
      ];
      const result = compileMetrics(metrics);
      expect(result).toBeDefined();
    ...
    it("should compile max metric", () => {
      const metrics = [
        { metric: "max" as const, field: "price" as AllowedColumns },
      ];
      const result = compileMetrics(metrics);
      expect(result).toBeDefined();
    ...
    it("should throw error for unsupported metric", () => {
      const metrics = [
        { metric: "invalid" as any, field: "price" as AllowedColumns },
      ];
      expect(() => compileMetrics(metrics)).toThrow(
        "Unsupported metric: invalid"
      );
    });

    it("should throw error for unsupported metric field", () => {
      const metrics = [
        { metric: "count" as const, field: "invalidField" as any },
      ];
      expect(() => compileMetrics(metrics)).toThrow(
