...
export const groupedByInseeCodeAndSection = createRoute({
  ...
  responses: {
    [HttpStatusCodes.OK]: jsonContent(
      z.array(SalesByInseeCodeAndSectionSchema),
      "List of analytics aggregated by insee code and section"
    ),
  },
});
...
export const groupedByPropertyType = createRoute({
  ...
  responses: {
    [HttpStatusCodes.OK]: jsonContent(
      z.array(SalesByPropertyTypeSchema),
      "List of analytics aggregated by property type"
    ),
  },
});
...
export const groupedByYear = createRoute({
  ...
  responses: {
    [HttpStatusCodes.OK]: jsonContent(
      z.array(SalesByYearSchema),
      "List of analytics aggregated by year"
    ),
  },
});
export const groupedByMonth = createRoute({
  ...
  responses: {
    [HttpStatusCodes.OK]: jsonContent(
      z.array(SalesByMonthSchema),
      "List of analytics aggregated by month"
    ),
  },
});
...
export type GroupedByPropertyTypeRoute = typeof groupedByPropertyType;
