...
const router = createRouter()
  ...
  .openapi(
    slopesRoutes.getAptsByInseeCodeMonthSlope,
    slopesHandlers.getAptsByInseeCodeMonthSlope
  )
  .openapi(
    slopesRoutes.getHousesByInseeCodeMonthSlope,
    slopesHandlers.getHousesByInseeCodeMonthSlope
  )
  .openapi(
    slopesRoutes.getAptsBySectionMonthSlope,
    slopesHandlers.getAptsBySectionMonthSlope
  )
  .openapi(
    slopesRoutes.getHousesBySectionMonthSlope,
    slopesHandlers.getHousesBySectionMonthSlope
  )
  .openapi(
