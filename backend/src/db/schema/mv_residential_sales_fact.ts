...
export const residential_sales_fact = pgMaterializedView(
  "residential_sales_fact"
).as((qb) =>
  qb
    .select({
      id: propertySales.id,
...
export const residential_topk_by_insee_month = pgMaterializedView(
  "residential_topk_by_insee_month"
).as((qb) =>
  qb
    .select({
      id: propertySales.id,
...
export const residential_topk_by_insee_year = pgMaterializedView(
  "residential_topk_by_insee_year"
).as((qb) =>
  qb
    .select({
      id: propertySales.id,
