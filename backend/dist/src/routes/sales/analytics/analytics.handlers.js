import { getSalesByInseeCode, getSalesByMonth, getSalesByPropertyType, getSalesByInseeCodeAndSection, getSalesByYear, getSalesSummary, getPricePerM2Deciles, } from "../../../repositories/analytics.queries";
