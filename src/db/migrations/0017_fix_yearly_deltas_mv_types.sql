...
CREATE MATERIALIZED VIEW "public"."apartments_by_insee_code_year_deltas" AS (
  SELECT
    ...
    base."min_price"::double precision AS "min_price_base",
    current."min_price"::double precision AS "min_price_current",
    (current."min_price"::double precision - base."min_price"::double precision)::double precision AS "min_price_delta",
    CASE WHEN base."min_price" IS NULL OR base."min_price" = 0 THEN NULL ELSE round((100.0 * (current."min_price"::double precision - base."min_price"::double precision) / base."min_price"::double precision)::numeric, 2)::double precision END AS "min_price_pct_change",
    base."max_price"::double precision AS "max_price_base",
    current."max_price"::double precision AS "max_price_current",
    (current."max_price"::double precision - base."max_price"::double precision)::double precision AS "max_price_delta",
    CASE WHEN base."max_price" IS NULL OR base."max_price" = 0 THEN NULL ELSE round((100.0 * (current."max_price"::double precision - base."max_price"::double precision) / base."max_price"::double precision)::numeric, 2)::double precision END AS "max_price_pct_change",
    ...
    base."min_price_m2"::double precision AS "min_price_m2_base",
    current."min_price_m2"::double precision AS "min_price_m2_current",
    (current."min_price_m2"::double precision - base."min_price_m2"::double precision)::double precision AS "min_price_m2_delta",
    CASE WHEN base."min_price_m2" IS NULL OR base."min_price_m2" = 0 THEN NULL ELSE round((100.0 * (current."min_price_m2"::double precision - base."min_price_m2"::double precision) / base."min_price_m2"::double precision)::numeric, 2)::double precision END AS "min_price_m2_pct_change",
    base."max_price_m2"::double precision AS "max_price_m2_base",
    current."max_price_m2"::double precision AS "max_price_m2_current",
    (current."max_price_m2"::double precision - base."max_price_m2"::double precision)::double precision AS "max_price_m2_delta",
    CASE WHEN base."max_price_m2" IS NULL OR base."max_price_m2" = 0 THEN NULL ELSE round((100.0 * (current."max_price_m2"::double precision - base."max_price_m2"::double precision) / base."max_price_m2"::double precision)::numeric, 2)::double precision END AS "max_price_m2_pct_change",
