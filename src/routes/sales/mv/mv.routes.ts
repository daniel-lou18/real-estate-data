...
import {
  ApartmentsByInseeMonthSchema,
  HousesByInseeMonthSchema,
  ApartmentsByInseeYearSchema,
  HousesByInseeYearSchema,
  InseeMonthParamsSchema,
  InseeYearParamsSchema,
...
export const getAptsByInseeCodeYear = createRoute({
  ...
  responses: {
    [HttpStatusCodes.OK]: jsonContent(
      z.array(ApartmentsByInseeYearSchema),
      "List of apartments by insee code, year"
    ),
  },
});
...
export const getHousesByInseeCodeYear = createRoute({
  ...
  responses: {
    [HttpStatusCodes.OK]: jsonContent(
      z.array(HousesByInseeYearSchema),
      "List of houses by insee code, year"
    ),
  },
});
...
export const getAptsByInseeCodeMonth = createRoute({
  ...
  responses: {
    [HttpStatusCodes.OK]: jsonContent(
      z.array(ApartmentsByInseeMonthSchema),
      "List of apartments by insee code, year, month"
    ),
  },
});
...
export const getHousesByInseeCodeMonth = createRoute({
  ...
  responses: {
    [HttpStatusCodes.OK]: jsonContent(
      z.array(HousesByInseeMonthSchema),
      "List of houses by insee code, year, month"
    ),
  },
});
...
export const getAptsByInseeCodeWeek = createRoute({
  ...
  responses: {
    [HttpStatusCodes.OK]: jsonContent(
      z.array(ApartmentsByInseeWeekSchema),
      "List of apartments by insee code, year, week"
    ),
  },
});
...
export const getHousesByInseeCodeWeek = createRoute({
  ...
  responses: {
    [HttpStatusCodes.OK]: jsonContent(
      z.array(HousesByInseeWeekSchema),
      "List of houses by insee code, year, week"
    ),
  },
});
