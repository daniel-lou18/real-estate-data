...
export const getOne = createRoute({
    ...
    responses: {
        [HttpStatusCodes.OK]: jsonContent(SelectPropertySaleSchema, "The requested property sale"),
        [HttpStatusCodes.NOT_FOUND]: jsonContent(notFoundSchema, "Property sale not found"),
